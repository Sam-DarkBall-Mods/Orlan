...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_legacy_history_is_connected(self) -> None:
        self.assertTrue((ROOT / "addons" / "orlan" / "config.cpp").is_file())
        self.assertTrue(
            (ROOT / "optionals" / "orlan_fire_support" / "config.cpp").is_file()
        )
